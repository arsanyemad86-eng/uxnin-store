...
export const CATEGORIES = [
  ...
  { key: "whey-protein", name: "Whey Protein", icon: "W" },
  { key: "creatine", name: "Creatine", icon: "C" },
  { key: "mass", name: "Mass Gainers", icon: "M" },
  { key: "pre-workout", name: "Pre-Workout", icon: "P" },
  { key: "vitamins", name: "Vitamins", icon: "V" },
  { key: "beta-alanine", name: "Beta Alanine", icon: "β" },
];
